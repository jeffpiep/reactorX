...
exe.O:?,"FIRE":W.STRIG(0):WE.:CLS:W.K<3ANDL>0:a(0)=0:incC:se.1,C,15:i.C MODT=0:C.2:R=C/T:exe.O:end.:P.53248,124+X(0)
m.adr("    !!q°q!!    ")+1,B+561+Y(0),15:f.i=1to3:m.adr("     0Xx0     ")+1,B+561+i*128+Y(i),14:E=(125+X(i))*(a(i)=0)
P.53248+i,E:n.i:P.53278,1:pa.1:f.i=0to3:U(i)=0:V(i)=0:M=peek(53252+i):i.M&1=1:a(i)=1:i.i=0:ms.$A200,128,0:decL:Y(i)=-R-5
...
Y(0)=Y(0)+E:X(0)=X(0)+U(0)+2*((G&4=4)-(G&8=8)):WE.:S.:i.K=3anda(0)=0:?,"win!";:e.:?,"meltdown";:end.:do:l.:pro._
